...
class Enemy:
    ...
    def draw_path(self):
        for indx, step in enumerate(self.path[1:-1]):
            pygame.draw.rect(self.application.screen, (0, min(indx + 100, 255),0), (step[0] * self.application.cell_width + PADDING // 2 + 4,
                                                             step[1] * self.application.cell_height + PADDING // 2 + 4,
                                                             self.application.cell_width - 7,
                                                             self.application.cell_height - 7))
